...
function initializeMermaid() {
    return new Promise((resolve, reject) => {
        // Create a script element for mermaid.min.js
...
function initializeFeatherlight() {
    return new Promise((resolve, reject) => {        
        const script = document.createElement("script");
...
function renderMermaid() {
    // Initialize mermaid when the script is fully loaded
    initializeMermaid()
        .then(() => {
            mermaid.initialize({
                startOnLoad:false,
        ...
        .catch((error) => {
            console.error("Failed to load mermaid.min.js", error);
        });
}

function renderFeatherlight() {
    // Initialize mermaid when the script is fully loaded
    initializejQuery()
        .then(() => initializeFeatherlight())
        .then(() => {
        ...
        .catch((error) => {
            console.error("Failed to load featherlight.min.js", error);
        });
}
